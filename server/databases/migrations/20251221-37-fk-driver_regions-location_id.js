/**
 * @file databases/migrations/20251221-37-fk-driver_regions-location_id.js
 * @description Add on driver_region-location_id
...
// Constraint명 
const constraintName = 'fk-driver_regions-location_id'; 

// Constraint 정의 
const options = {
  fields: ['location_id'],               // fk 부여할 컬럼
  type: 'foreign key',                  // constraint 종류
  name: constraintName,                // constraint명 지정 (constraint명_테이블명_컬럼명)
  references: {                         // 참조 설정 
    table: 'locations',                  // 참조할 테이블
    field: 'id',                        // 참조 컬럼 지정
  },
