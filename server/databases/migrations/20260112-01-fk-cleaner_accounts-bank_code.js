/**
 * @file databases/migrations/20260112-01-fk-cleaner_accounts-bank_code.js
 * @description Add on cleaner_accounts.bank_code
...
// Constraint명 
const constraintName = 'fk_cleaner_accounts_bank_code'; 

// Constraint 정의 
const options = {
  fields: ['bank_code'],                 // fk 부여할 컬럼
  type: 'foreign key',                  // constraint 종류
  name: constraintName,                 // constraint명 지정 (constraint명_테이블명_컬럼명)
  references: {                         // 참조 설정 
    table: 'bank_codes',                    // 참조할 테이블
    field: 'code',                        // 참조 컬럼 지정
  },
